...
CLOSE ON SOMETHING ANSWERABLE: End with a question a reader can answer in three words without thinking hard — a choice between two concrete things, or which of two they would pick. "Ceramic or steel?" works. "What do you think?" and "Are you struggling with this?" do not: the first is a rhetorical opener disguised as a question, the second asks the reader to describe their own failure in public, and neither gets typed. Comments are the strongest reach signal after sends, and they are earned by lowering the cost of replying, not by asking harder.
WRITE IT TO BE FORWARDED: One sentence should describe a PERSON rather than a benefit — the friend who always does this, the colleague who needs to hear it. A reader sends a post when it identifies someone they know; they rarely send a claim about a product. This is the single highest-leverage line in the caption, because a send reaches an audience we do not have.
